...
def run_workflow(DATA_PATH, run=False):
    props = Properties()
    ...
    available_images     = 'config/galaxy_data_dev.log'
    ...
    galaxy_container = Container(
                ...
                image = "file://${PWD}/containers/galaxy-container-tracking.sif",
                image_site = "local",
    ...
    vgg16_hpo = Transformation("vgg16_hpo",
                ...
                .add_pegasus_profile(cores=24, memory=32768)
    ...
    eval_model = Transformation("eval_model",
                 ...
                 .add_pegasus_profile(cores=8, memory=16384)
    ...
    ## CREATE WORKFLOW
    #---------------------------------------------------------------------------------------------------------
    wf = Workflow('Galaxy-Classification-Workflow', tracker_type="full")

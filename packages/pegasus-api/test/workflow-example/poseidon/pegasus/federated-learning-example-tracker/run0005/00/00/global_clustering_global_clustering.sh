...
pegasus-kickstart  -n global_clustering -N global_clustering -R condorpool  -L federated-learning-example-tracker -T 2024-02-20T19:12:32+00:00 ./global_clustering -f worker-1.novalocal_clusters.csv worker-2.novalocal_clusters.csv worker-3.novalocal_clusters.csv
set -e

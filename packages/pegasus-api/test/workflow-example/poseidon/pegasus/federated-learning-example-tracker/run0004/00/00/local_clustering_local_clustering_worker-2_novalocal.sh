...
pegasus-kickstart  -n local_clustering -N local_clustering_worker-2.novalocal -R condorpool  -L federated-learning-example-tracker -T 2024-02-20T14:12:44+00:00 ./local_clustering -f worker-2.novalocal_data.csv -dist ref_dist.npy -node worker-2.novalocal
set -e

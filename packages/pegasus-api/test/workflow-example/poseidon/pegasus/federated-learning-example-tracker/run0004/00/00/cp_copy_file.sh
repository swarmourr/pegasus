...
pegasus-kickstart  -n cp -N copy_file -R local  -L federated-learning-example-tracker -T 2024-02-20T14:12:44+00:00 /bin/cp metadata.yaml /home/poseidon/.pegasus/
job_ec=$?

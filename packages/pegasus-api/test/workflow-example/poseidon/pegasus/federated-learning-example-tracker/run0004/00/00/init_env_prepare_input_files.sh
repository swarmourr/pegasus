...
pegasus-kickstart  -n init_env -N prepare_input_files -R condorpool  -L federated-learning-example-tracker -T 2024-02-20T14:12:44+00:00 ./init_env -f source_data -size 10000 -n global_model_round_init.h5 -s 784 -c 10
set -e

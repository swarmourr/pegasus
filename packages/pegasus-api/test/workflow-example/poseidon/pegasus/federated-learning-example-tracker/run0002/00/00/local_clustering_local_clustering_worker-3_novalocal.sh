...
pegasus-kickstart  -n local_clustering -N local_clustering_worker-3.novalocal -R condorpool  -L federated-learning-example-tracker -T 2024-02-20T13:48:43+00:00 ./local_clustering -f worker-3.novalocal_data.csv -dist ref_dist.npy -node worker-3.novalocal
set -e

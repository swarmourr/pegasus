...
pegasus-kickstart  -n data_tracker -N tracker_data_job_local_clustering_worker-3.novalocal_output -R condorpool  -s pegasus-data/metadata_local_clustering_worker-3.novalocal_output.yaml=pegasus-data/metadata_local_clustering_worker-3.novalocal_output.yaml -L federated-learning-example-tracker -T 2024-02-20T13:48:43+00:00 ./data_tracker -files worker-3.novalocal_clusters.csv -data_dir pegasus-data -metadata_format yaml -o pegasus-data/metadata_local_clustering_worker-3.novalocal_output -file_type outputs -pfn /home/poseidon/pegasus-integration/pegasus/packages/pegasus-api/test/workflow-example/worker-3.novalocal_clusters.csv -gdrive -remote_id 1KLUNrJNfCDI8Y5iXBmASUbtwqCpaHg3L -gcredentials cred
set -e

...
pegasus-kickstart  -n local_clustering -N local_clustering_worker-1.novalocal -R condorpool  -L federated-learning-example-tracker -T 2024-02-20T19:25:35+00:00 ./local_clustering -f worker-1.novalocal_data.csv -dist ref_dist.npy -node worker-1.novalocal
set -e
